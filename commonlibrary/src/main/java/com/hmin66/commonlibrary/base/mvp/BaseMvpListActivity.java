...
import com.hmin66.commonlibrary.base.BaseListActivity;
...
public abstract class BaseMvpListActivity<P extends BasePresenter>
        extends BaseListActivity implements BaseContract.IView,
    ...
    public <T> ObservableTransformer<T, T> applySchedulers() {
        return new ObservableTransformer<T, T>() {
            ...
            public ObservableSource<T> apply(Observable<T> upstream) {
                return upstream
                        .compose(BaseMvpListActivity.this.<T>bindUntilEvent(ActivityEvent.DESTROY))
        ...
        return new ObservableTransformer<HttpListResponse<T>, HttpListResponse.DataBean<T>>() {
            ...
            public ObservableSource<HttpListResponse.DataBean<T>> apply(Observable<HttpListResponse<T>> upstream) {
                return upstream
                        ...
                        .compose(BaseMvpListActivity.this.<HttpListResponse.DataBean<T>>bindUntilEvent(ActivityEvent.DESTROY))
                        .subscribeOn(Schedulers.io())
                        .observeOn(AndroidSchedulers.mainThread());
            }
        };
