...
public final class PermissionSetting {
    ...
    private PermissionSetting(Context context) {
        this.mContext = context;
    }

    public static PermissionSetting create(Context context){
        return new PermissionSetting(context);
    }

    public void showSetting(final List<String> permissions, onCancelListener listener) {
