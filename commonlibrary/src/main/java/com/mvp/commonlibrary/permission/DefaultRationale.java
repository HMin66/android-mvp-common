...
public final class DefaultRationale implements Rationale {
    ...
    public static Rationale mInstance;

    public static Rationale getInstance(){
        if (mInstance == null){
            synchronized (DefaultRationale.class){
                if (mInstance == null){
                    mInstance = new DefaultRationale();
                }
            }
        }
        return mInstance;
